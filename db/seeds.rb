...
tafanel = Supplier.create!(email: 'vincent@come2link.com', name: "Ets Tafanel", address: "31 Rue Montorgueil", zip: "75001", locality: "Paris", phone_number: "01.46.12.08.92", sector: "Boissons", siret: "798 578 333 000 20")
richard = Supplier.create!(email: 'vincent@icloud.com', name: "Cafés Richard", address: "32 Rue Montorgueil", zip: "75001", locality: "Paris", phone_number: "01.46.12.08.93", sector: "Cafés", siret: "798 578 222 000 20")
...
monday_thursday   = DeliveryCondition.create!(order_deadlines: [nil, 2, nil, nil, 1, nil, nil], undelivery_days: [0, 2, 3, 5, 6] ,holidays: [], relation: boisson)
tuesday_friday    = DeliveryCondition.create!(order_deadlines: [nil, nil, 3, nil, nil, 1, nil], undelivery_days: [0, 1, 3, 4, 6], holidays: [], relation: cafe)
friday            = DeliveryCondition.create!(order_deadlines: [nil, nil, nil, nil, nil, 1.5, nil], undelivery_days: [0, 1, 2, 3, 4, 6], holidays: [], relation: vin)
